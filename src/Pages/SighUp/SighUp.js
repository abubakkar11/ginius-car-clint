    ...
    return (
        <div className="hero">
            <div className="hero-content flex-col justify-between gap-36 lg:flex-row">
                ...
                <h1 className="text-5xl text-center font-bold">Sigh Up</h1>
                    <form onSubmit={handleSubmit} className="card-body">
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Name</span>
                            </label>
                            <input type="text" placeholder="You Name" name='name' className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control mt-6">
                            <input className="btn btn-primary" type="submit" value="Sigh Up" />
                        </div>
